...
namespace{
	...
	enum th1flist_{
		...
		ABCDana_CutFlow_UnWt, 		//01-13
		ABCDval_CutFlow_UnWt, 		//01-13
	...
	struct TH1Info_ TH1Info[TH1_Size_] = {
		{ 0,	"ABCDana_CutFlow",			"",	"Cut flow", 			"Yields", "", 		8, 0, 8}, 	
		{ 0,	"ABCDval_CutFlow",			"",	"Cut flow", 			"Yields", "", 		8, 0, 8}, 	
		{ 0,	"ABCDana_CutFlow_UnWt",			"",	"Cut flow", 			"Yields", "", 		8, 0, 8}, 	
		{ 0,	"ABCDval_CutFlow_UnWt",			"",	"Cut flow", 			"Yields", "", 		8, 0, 8}, 	
