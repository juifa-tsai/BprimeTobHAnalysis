...
TH1Info TH1InfoClass<TH1_type>::Var[TH1_Size_] = { 
  ...
  TH1Info( 0,	"ABCDana_HT", 			"",	"HT(AK5)", 			"Yields", "GeV/c", 	4000, 0, 4000 ) , 	
  TH1Info( 0,	"ABCDana_HT_A", 		"",	"HT(AK5)", 			"Yields", "GeV/c", 	4000, 0, 4000 ) , 	
  TH1Info( 0,	"ABCDana_HT_B", 		"",	"HT(AK5)", 			"Yields", "GeV/c", 	4000, 0, 4000 ) , 	
  TH1Info( 0,	"ABCDana_HT_C", 		"",	"HT(AK5)", 			"Yields", "GeV/c", 	4000, 0, 4000 ) , 	
  TH1Info( 0,	"ABCDana_HT_D", 		"",	"HT(AK5)", 			"Yields", "GeV/c", 	4000, 0, 4000 ) , 	
