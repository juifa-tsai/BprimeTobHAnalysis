...
def main():
  ...
  parser.add_option("-o", "--output_filename", dest="output_filename", action='store', default='bprimeTobHAnalysis', help="Output ROOT filename (Default set to bprimeTobH)", metavar="OUTPUT_FILENAME")
